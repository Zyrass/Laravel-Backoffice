  ...
  <section>
    ...
    <form action="{{ route('directors.store') }}" method="POST">
      ...
      <div class="well col-lg-12" id="divFormAjout">
        <h2 class="text-center text-primary">Formulaire d'ajout d'un nouveau réalisateur</h2>
        <hr />
        <div class="col-lg-6">
        ...
        <div class="col-lg-6">
          <fieldset class="form-group">
            <label for="image">Portrait du réalisateur</label>
            <input type="text" class="form-control" id="image" name="image" placeholder="Saisissez l'url du portrait du réalisateur au format jpg">
          </fieldset>
          ...
          <fieldset class="form-group">
            <label for="notePresse">Note de presse</label>
            <select class="form-control" id="notePresse" name="notePresse">
              <option>0</option>
              <option>1</option>
              <option>2</option>
              <option>3</option>
